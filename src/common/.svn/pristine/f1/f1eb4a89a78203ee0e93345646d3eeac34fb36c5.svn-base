...
public interface ICmdToModelAdapter<M extends IMessage, S extends ISender> {
	 ...
	 * @param <T> - the type of object retrieved from dictionary
	 ...
	 * @param obj The data.
	 * @param <T> - the type of object placed in dictionary
	 */
